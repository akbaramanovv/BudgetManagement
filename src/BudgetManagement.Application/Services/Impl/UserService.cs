...
using BudgetManagement.Application.Templates;
...
namespace BudgetManagement.Application.Services.Impl
{
    public class UserService : IUserService
    {
        ...
        public async Task<CreateUserResponseModel> CreateAsync(CreateUserModel createUserModel)
        {
            ...
            await _emailService.SendEmailAsync(EmailMessage.Create(user.Email, emailBody, "[BudgetManagement]Confirm your email"));
